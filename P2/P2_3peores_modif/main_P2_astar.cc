...
int main(int argc, char* argv[]) {
  ...
  if (mode == 0) {
    std::string output_file = "resultado_3peores_" + filename;
    ...
    file << "=== A* MODIFICADO (3 PEORES) - 10 REPETICIONES ===" << std::endl;
    ...
    for (int rep = 1; rep <= 10; ++rep) {
      ...
      AStarResult result = astar.Search3Worst(start, goal, false);
